...
[ComVisible(true)]
public class DLL_Shellcode_Runner_Caesar_ExNuma
{
    ...
    public static void SleepForEmu()
    {
    ...
    public DLL_Shellcode_Runner_Caesar_ExNuma()
    {
